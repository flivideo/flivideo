<!-- FliVideo source bundle · teletubby AGENT-NOTES · generated from teletubby/docs/AGENT-NOTES.md -->
...
- Schema drift check: `python3 ~/dev/ad/appydave-plugins/dev-team/skills/schema-mirror/scripts/verify_mirror.py docs/schema-mirror.json`.
